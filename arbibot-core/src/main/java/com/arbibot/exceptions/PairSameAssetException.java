...
/**
 * Exception thrown when the two {@link com.arbibot.entities.Asset} used to create a {@link com.arbibot.entities.Pair} are the same.
...
public class PairSameAssetException extends RuntimeException {
    ...
    public PairSameAssetException(Asset asset1, Asset asset2) {
        super("The two assets (" + asset1.getName() + " and " + asset2.getName() + " ) used to create a pair must be different.");
    }
}