 ...
 * <p>
 * The {@code OrderLimit} class extends the {@link Order} class to include an additional
 ...
 * <pre>
 * {@code
 * OrderLimit orderFromDb = new OrderLimit(brokerId, action, type, tradingPair, creationTime, openTime, filledTime, canceledTime, quantity, prices, quantities, feeAsset, fees, limitPrice);
