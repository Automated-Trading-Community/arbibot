 ...
 * An asset is any resource or item that holds value and can be traded in the financial market.
 ...
 * 
 * The {@code id} field is automatically generated using an {@link AtomicInteger} to ensure 
 * that each asset instance has a unique identifier.
 * 
 * The {@code name} field represents the name of the asset and is accessible and modifiable 
...
public class Asset {
    ...
    /**
     * Private constructor to create an {@code Asset} instance with a specified name.
