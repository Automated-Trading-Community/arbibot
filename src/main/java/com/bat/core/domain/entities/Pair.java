 ...
 * For example, in the trading pair BTC/USD, BTC is the base asset and USD is the quote asset.
 * 
 * This class includes:
 * - A unique identifier for the trading pair.
 * - A base asset which is the primary asset in the pair.
 * - A quote asset which is the asset in which the value of the base asset is quoted.
 * 
 * Example usage:
 * <pre>
 * {@code
