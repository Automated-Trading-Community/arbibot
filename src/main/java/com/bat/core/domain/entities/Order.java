...
import com.bat.core.domain.exceptions.OrderMisMatchException;
 ...
 * </p>
 * <ul>
 *   <li>The first constructor is used to initialize an order when loading from the database.</li>
 *   <li>The second constructor creates an order in memory directly, with a default type of market and status of open.</li>
 * </ul>
 * 
 * <p>Example usage:</p>
 * <pre>
 * {@code
 * Order orderFromDb = new Order(brokerId, action, type, tradingPair, creationTime, openTime, filledTime, canceledTime, quantity, prices, quantities, feeAsset, fees);
...
abstract public class Order {
     ...
     * @param filledPrice the list of prices at which portions of the order were filled
     * @param filledQuantity the list of quantities that were filled at corresponding prices
     ...
     * @throws OrderMisMatchException if the order is still open or if there is a mismatch between the filled quantity and the base quantity
     */
